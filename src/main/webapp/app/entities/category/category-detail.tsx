  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="learnerappApp.category.detail.title">Category</Translate> [<b>{categoryEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{categoryEntity.userExtra ? categoryEntity.userExtra.id : ''}</dd>
          </dl>
