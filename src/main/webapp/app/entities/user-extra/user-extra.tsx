    ...
    return (
      <div>
        <h2 id="user-extra-heading">
          <Translate contentKey="learnerappApp.userExtra.home.title">User Extras</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="learnerappApp.userExtra.home.createLabel">Create new User Extra</Translate>
          </Link>
        </h2>
