...
export interface IUserExtraDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="learnerappApp.userExtra.delete.question" interpolate={{ id: userExtraEntity.id }}>
