...
export class Tag extends React.Component<ITagProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="tag-heading">
          <Translate contentKey="learnerappApp.tag.home.title">Tags</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="learnerappApp.tag.home.createLabel">Create new Tag</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="learnerappApp.tag.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
