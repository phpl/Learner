...
import { getEntity } from 'app/entities/card/card.reducer';
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="learnerappApp.card.detail.title">Card</Translate>
          </h2>
          ...
          <Button tag={Link} to="/flashcards/card" replace color="info">
            <FontAwesomeIcon icon="arrow-left" />{' '}
            <span className="d-none d-md-inline">
              <Translate contentKey="entity.action.back">Back</Translate>
            </span>
          </Button>&nbsp;
          <Button tag={Link} to={`/flashcards/card/${cardEntity.id}/edit`} replace color="primary">
