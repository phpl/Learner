...
import { getEntity } from 'app/entities/category/category.reducer';
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="learnerappApp.category.detail.title">Category</Translate>
          </h2>
          ...
          <Button tag={Link} to="/flashcards/category" replace color="info">
            <FontAwesomeIcon icon="arrow-left" />{' '}
            <span className="d-none d-md-inline">
              <Translate contentKey="entity.action.back">Back</Translate>
            </span>
          </Button>&nbsp;
          <Button tag={Link} to={`/flashcards/category/${categoryEntity.id}/edit`} replace color="primary">
